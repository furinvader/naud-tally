...
- [T-000 Choose the Open-Source License](done/T-000.md)
- [T-001 Confirm Pilot Rules](done/T-001.md)
- [T-002 Choose the Initial Stack](done/T-002.md)
...
- [T-013 Apply the Design Foundations to the Angular Theme](done/T-013.md)
