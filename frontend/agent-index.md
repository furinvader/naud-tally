...
- For order-entry route state and inactivity ownership, read [`src/app/features/order-entry/order-entry.store.ts`](src/app/features/order-entry/order-entry.store.ts), [`src/app/features/order-entry/order-entry.ts`](src/app/features/order-entry/order-entry.ts), and [`src/app/features/order-entry/order-entry.store.spec.ts`](src/app/features/order-entry/order-entry.store.spec.ts).
...
- For the current drink tally feature, read [`src/app/features/drink-tally/drink-tally.ts`](src/app/features/drink-tally/drink-tally.ts), [`src/app/features/drink-tally/drink-tally.html`](src/app/features/drink-tally/drink-tally.html), and [`src/app/features/drink-tally/drink-tally.scss`](src/app/features/drink-tally/drink-tally.scss).
