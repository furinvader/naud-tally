...
- [`docs/agent-decisions.md`](docs/agent-decisions.md) for repo-wide decisions
- [`frontend/agent-decisions.md`](frontend/agent-decisions.md) for frontend-local architecture, tooling, and convention decisions
